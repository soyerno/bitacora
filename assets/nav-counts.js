 ...
 *
 * Counter elements expected: #nav-count-decks, #nav-count-rfcs, #nav-count-postmans, #nav-count-rd, #nav-count-bitacora, #nav-count-proyectos
 * Data: <site-root>/decks/decks.json, <site-root>/rfcs/rfcs.json,
 *       <site-root>/postmans/postmans.json, <site-root>/rd/rd.json,
 *       <site-root>/bitacora/bitacora.json, <site-root>/proyectos/proyectos.json
 */
(function () {
  'use strict';
  ...
  var targets = [
    ...
    { id: 'nav-count-bitacora', url: BASE + 'bitacora/bitacora.json', key: 'items'    },
